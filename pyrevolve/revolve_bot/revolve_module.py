...
class LinearActuatorModule(RevolveModule):
    ...
    """
    TYPE = 'LinearActuator'
    VISUAL_MESH_FRAME = 'model://rg_robot/meshes/1.dae'
    VISUAL_MESH_SERVO = 'model://rg_robot/meshes/2.dae'
    COLLISION_BOX_FRAME = (5.50e-02, 1.575e-02, 1.5e-02)
    COLLISION_BOX_SERVO = (1e-02, 0.5e-02, 0.5e-02)
    COLLISION_BOX_SERVO_2 = (1.0e-3, 3.4e-2, 3.4e-02)
    COLLISION_BOX_SERVO_OFFSET = (
        SDF.math.Vector3(0.018, 0, 0),
        SDF.math.Vector3(0, 0, 0),
    )
    MASS_FRAME = grams(1.7)
    MASS_SERVO = grams(9)
