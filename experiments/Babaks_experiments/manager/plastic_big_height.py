...
async def run():
    ...
    def fitness_function_height(robot_manager, robot):
        return fitness.standingHeight(robot_manager, robot, False)

    fitness_function = {'plane': fitness_function_height}
                        #'plane': fitness_function_plane},
                        #'plane': fitness_function_dvh_c_5050}#,
